          ...
          children: <Widget>[
            Column(
              children: <Widget>[
                AspectRatio(
                  aspectRatio: 1.2,
                  child: Image.asset('assets/shopping/webInterFace.png'),
                ),
              ],
            ),
            Positioned(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: <BoxShadow>[
                    BoxShadow(
                        color: ShoppingPageTheme.grey.withOpacity(0.2),
                ...
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    child: const Icon(
                      ...
                      color: ShoppingPageTheme.nearlyBlack,
                    ),
                    onTap: () {
